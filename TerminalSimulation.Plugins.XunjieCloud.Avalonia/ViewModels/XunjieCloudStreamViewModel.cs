...
namespace TerminalSimulation.Plugins.XunjieCloud.Avalonia.ViewModels
{
    ...
    public partial class XunjieCloudStreamViewModel : ObservableObject, IDisposable
    {
        ...
        {
            if (parameter is global::Avalonia.Controls.TextBox tb && !string.IsNullOrEmpty(tb.Text))
            {
                Password = tb.Text; // Just as a simple fallback if we pass the box
            }
