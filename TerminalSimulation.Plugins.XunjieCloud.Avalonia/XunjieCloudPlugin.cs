...
using TerminalSimulation.Plugins.XunjieCloud.Avalonia.ViewModels;
using TerminalSimulation.Plugins.XunjieCloud.Avalonia.Views;

namespace TerminalSimulation.Plugins.XunjieCloud.Avalonia
{
    public class XunjieCloudPlugin : IPlugin
    {
        ...
        public Control GetConfigurationPanel()
        {
